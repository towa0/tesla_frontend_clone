...
export default function Navbar() {
  return (
    <div className="w-full h-[6vh] flex items-center justify-between px-4 bg-transparent z-50">
      <div className="flex items-center">
        <svg
          className="w-[7vw] ml-[3vw] text-lightText"
          viewBox="0 0 342 35"
      ...
      <div className="flex gap-x-8">
        <a href="#" className="text-lightText ">
          Vehicles
        </a>
        <a href="#" className="text-lightText ">
          Energy
      ...
      <div className="flex gap-4">
        <a href="">
          <svg
            className="w-[3vh] text-lightText"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
        ...
        <a href="">
          <svg
            className="w-[3vh] text-lightText mr-[4vw]"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
